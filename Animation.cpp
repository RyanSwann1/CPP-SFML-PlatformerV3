...
Animation::Animation(const std::string& name, const int startFrame, const int endFrame, const int row, const float frameTime, const int direction, const int repeatable)
	: m_timeElasped(0),
